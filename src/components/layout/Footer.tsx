      ...
      <div className="bg-primary/5 py-16">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center justify-center bg-primary/10 rounded-full px-6 py-2 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="https://twitter.com" className="bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-colors p-2 rounded-full">
                ...
                <a href="https://facebook.com" className="bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-colors p-2 rounded-full">
                  <svg className="h-5 w-5 text-muted-foreground" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://linkedin.com" className="bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-colors p-2 rounded-full">
                  <svg className="h-5 w-5 text-muted-foreground" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
