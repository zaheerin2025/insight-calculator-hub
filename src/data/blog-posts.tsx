...
export const blogPosts = [
  {
    ...
    content: (
      <>
        ...
        <p>According to the <a href="https://www.census.gov/housing/hvs/index.html" target="_blank" rel="noopener noreferrer">U.S. Census Bureau</a>, homeowners typically spend 1-4% of their home's value on maintenance each year. Be sure to factor this into your calculations.</p>
        ...
        <p>Ready to start your calculations? Try our <a href="/calculators/finance/mortgage-calculator">mortgage calculator</a> now to see what your future home payments might look like.</p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>According to the <a href="https://www.who.int/news-room/fact-sheets/detail/obesity-and-overweight" target="_blank" rel="noopener noreferrer">World Health Organization</a>, BMI values are typically categorized as follows:</p>
        ...
        <blockquote>
          ...
          <cite>— American Medical Association</cite>
        </blockquote>
        ...
        <div className="flex items-center bg-green-50 p-6 rounded-lg my-6 border-l-4 border-green-500">
          <div className="ml-4">
            ...
            <p>A meta-analysis published in <a href="https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(16)30054-X/fulltext" target="_blank" rel="noopener noreferrer">The Lancet</a> examined data from more than 10 million people and confirmed that both high and low BMI are associated with increased mortality risk.</p>
          </div>
        </div>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr>
                ...
                <th className="border p-2">Overweight Threshold</th>
                <th className="border p-2">Obese Threshold</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border p-2">WHO Standard</td>
                <td className="border p-2">25.0</td>
                <td className="border p-2">30.0</td>
              </tr>
              <tr>
                <td className="border p-2">Asian</td>
                <td className="border p-2">23.0</td>
                <td className="border p-2">27.5</td>
              </tr>
              <tr>
                <td className="border p-2">South Asian</td>
                <td className="border p-2">23.0</td>
                <td className="border p-2">25.0</td>
              </tr>
            </tbody>
        ...
        <p>If you're interested in calculating your BMI, try our <a href="/calculators/health/bmi-calculator">BMI calculator</a> as a first step in understanding your body composition. For a more comprehensive assessment, consider tracking other health metrics and consulting with healthcare professionals.</p>
      </>
    ),
